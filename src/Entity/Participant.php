...
class Participant implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Campus::class, inversedBy="etudiant")
    ...
    public function addSortiesParticpee(Sortie $sortiesParticpee): self
    {
        if (!$this->sortiesParticpees->contains($sortiesParticpee)) {
            ...
            $sortiesParticpee->addParticipant($this);
        }
    ...
    {
        if ($this->sortiesParticpees->removeElement($sortiesParticpee)) {
            $sortiesParticpee->removeParticipant($this);
        }
